...
class GeneratorCode  extends CallGenerator {
    ...
    public function getSite(){
        ...
        $mcd->table("actor")
                ...
                ->string("first_name", 30)->columnText("First Name")
                    ->inList()
                    ->mandatory()
                ->string("last_name", 30)->columnText("Last Name")
                    ->mandatory()
            ...
            ->table("film")
                ...
                ->string("title", 255)->columnText("Title")
                    ->inList()
                    ->mandatory()
                ->text("description")->columnText("Description")
                    ->inList()
                    ->mandatory()
                ->integer("release_year")->columnText("Release Year")
                    ->inList()
                    ->mandatory()
                ->smallInteger("original_language_id")
                ->tinyInteger("rental_duration")->columnText("Rental duration")
                    ->inList()
                    ->mandatory()
                    ->unit("days")
                ->decimal("rental_rate", 4, 2)->columnText("Rental Rate")
                    ->inList()
                    ->mandatory()
                    ->unit("$")
                ->tinyInteger("length")->columnText("Length")
                    ->inList()
                    ->mandatory()
                    ->unit("minutes")
                ->decimal("replacement_cost", 5, 2)->columnText("Replacement Cost")
                    ->inList(false)
                    ->mandatory(false)
                    ->unit("$")
            ...
            ->table("language")
                ...
                ->string("name", 20)->columnText("Name")
                    ->mandatory()
                ->timeStamp("last_update")
            ...
            ->table("category")
                ...
                ->string("name", 25)->columnText("Name")
                    ->mandatory()
                ->timeStamp("last_update")
                ->belongsToMany("film")
            ...
            ->table("customer")
                ...
                ->string("first_name", 25)->columnText("First Name")
                    ->mandatory()
                ->string("last_name", 45)->columnText("Last Name")
                    ->mandatory()
                ->string("email", 50)->columnText("Email")
                    ->mandatory()
                ->smallInteger("address_id")
                ->boolean("active")->columnText("Active")
                    ->inList(false)
                    ->mandatory(false)
                ->date("create_date")
                    ->inList()
            ...
            ->table("rental")
                ...
                ->date("rental_date")->columnText("Rental Date")
                    ->inList()
                    ->mandatory()
                ->smallInteger("inventory_id")
                ->smallInteger("customer_id")
                ->date("return_date")->columnText("Return Date")
                    ->inList()
                    ->mandatory()
            ...
            ->table("payment")
                ...
                ->decimal("amount", 4, 4)->columnText("Amount")
                    ->inList()
                    ->mandatory()
                    ->unit("$")
                ->date("payment_date", true, true)->columnText("Payement Date")
                ->belongsTo("rental")
                ->belongsTo("customer")
                ->belongsTo("staff")
                ->end()
            ...
            ->table("address")
                ...
                ->string("address", 50)->columnText("Address")
                    ->mandatory()
                ->string("address2", 50)->columnText("Address 2")
                ->string("district", 20)
                    ->mandatory()
                ->smallInteger("city_id")
                ->string("postal_code", 10)->columnText("Postal Code")
                    ->mandatory()
                ->string("phone", 20)->columnText("Phone")
                    ->mandatory()
                ->timeStamp("last_update")
                ->hasMany("customer")
            ...
            ->table("city")
                ->increments("city_id")
                ->string("city", 50)->columnText("City")
                    ->mandatory()
            ...
            ->table("country")
                ...
                ->string("country", 50)->columnText("Country")
                    ->mandatory()
                ->timeStamp("last_update")
                ->hasMany("city")
            ...
            ->table("staff")
                ->increments("staff_id")
                ->string("first_name", 45)->columnText("First Name")
                    ->mandatory()
                ->string("last_name", 15)->columnText("Last Name")
                    ->mandatory()
                ->smallInteger("address_id")
                //->blob("picture")
                ->string("email", 50)->columnText("Email")
                    ->mandatory()
                ->smallInteger("store_id")
                ->tinyInteger("active")->columnText("Active")
                    ->mandatory(true)
                    ->inList(false)
                ->string("username", 16)->columnText("User Name")
                    ->mandatory()
                ->string("password", 40)->columnText("Password")
                    ->mandatory(true)
                    ->inList(false)
                ->timeStamp("last_update")
                ->hasMany("rental")
