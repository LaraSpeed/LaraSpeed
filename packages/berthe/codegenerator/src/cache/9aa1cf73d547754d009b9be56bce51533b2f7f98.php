...
<form action="<?php echo e($table['title']); ?>" method="post"><?php if( array_key_exists('attributs', $table) ): ?><?php $__currentLoopData = $table['attributs']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attrName => $attrType): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
		<?php if(gettype($attrType) == gettype('')): ?>
				...
				<div class="form-group-lg">
					...
					<input type="text" name="<?php echo e($attrName); ?>" class="form-control" placeholder="<?php echo e($attrName); ?>"/>
				</div>
		<?php endif; ?>

		<?php if(gettype($attrType) == gettype(0)): ?>    	<div class="form-group-lg">
						<label id="<?php echo e($attrName); ?>"><?php echo e(ucfirst($attrName)); ?></label>
						<input type="number" name="<?php echo e($attrName); ?>" class="form-control" placeholder="<?php echo e($attrName); ?>"/>
				</div>
