    <div class="row">
        <div class="col-md-4">
            <h1 class="text-danger">List of <?php echo e(ucfirst($config->getPluralForm($otherTable))); ?></h1>
        </div>
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <h2 class="panel-title"><?php echo e(ucfirst($config->getPluralForm($otherTable))); ?></h2>
        </header>
