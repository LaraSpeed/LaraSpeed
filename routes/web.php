...
Route::post('inventory/updateStore/{inventory}', 'InventoryController@updateStore');
...
Route::post('rental/updateInventory/{rental}', 'RentalController@updateInventory');
...
Route::post('store/addInventory/{store}', 'StoreController@addInventory');
