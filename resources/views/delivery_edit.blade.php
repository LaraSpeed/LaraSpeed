    ...
    <form method="post" action="{{url("delivery/$delivery->id")}}">
        ...
        <div class="form-group">
            <label class="text-danger text-md">Identifiant : </label>
             <input type ="text" class="form-control" name="identifiant" value = "{{$delivery->identifiant}}"placeholder="Identifiant"  required />         </div>
        ...
        <div class="form-group">
            <label class="text-danger text-md">Articles : </label>
             <textarea name="articles" rows="10" cols="40" class="form-control"">{{$delivery->articles}}</textarea>         </div>
