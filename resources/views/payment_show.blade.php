                        ...
                        @forelse($payments as $payment)
                            <tr>
                                ...
                                <td nowrap>
                                    ...
                                    <a href="" ng-click="showModal('Delete', 'Do you really want to delete {{ $payment->amount}} ?', '{{url("/payment/$payment->payment_id")}}')" data-toggle="tooltip" data-placement="top" title="Delete">
